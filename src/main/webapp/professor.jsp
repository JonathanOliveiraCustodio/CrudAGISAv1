	...
	<div class="container py-4">
		<div class="p-5 mb-4 bg-body-tertiary rounded-3 text-center shadow">
			<div class="container-fluid py-5">
				<h1 class="display-5 fw-bold">Manuten��o de Profesor</h1>
		        <div class="d-flex gap-2 justify-content-center py-2">
					<form action="professor" method="post" class="row g-3 mt-3">
						<label for="data" class="form-label col-md-1">C�digo:</label> 
						<div class="col-md-2">	
							<input
						...
						<label for="data" class="form-label col-md-1">Titula��o:</label>
						<div class="col-md-3">	
							<input
