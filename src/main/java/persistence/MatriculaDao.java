...
public class MatriculaDao {
	...
	public Matricula buscarMatriculaAluno(Aluno a, Date dataMatriculaInicio, Date dataMatriculaFim) throws NumberFormatException, SQLException, ClassNotFoundException {
	...
	public Matricula buscarMatriculaAtualAluno(Aluno a) throws NumberFormatException, SQLException, ClassNotFoundException {
		Connection c = gDao.getConnection();
